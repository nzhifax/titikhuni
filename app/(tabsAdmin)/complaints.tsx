...
const dummyComplaints: Complaint[] = [
  {
    id: "c1", reporter: "Dewi Lestari", property: "Sawah Subur Bantul",
    category: "Fraud", date: "2026-07-02", status: "open",
    message: "The property listing shows incorrect land area. The actual area is smaller than advertised.",
  },
  {
    id: "c2", reporter: "Andi Prasetyo", property: "Kebun Durian Sleman",
    category: "Misinformation", date: "2026-07-04", status: "in_progress",
    message: "The photos shown are not from the actual property location. Suspected misleading listing.",
  },
  {
    id: "c3", reporter: "Rina Wulandari", property: "Tanah Kavling Magelang",
    category: "Legal Issue", date: "2026-06-28", status: "resolved",
    message: "Certificate dispute with neighboring land owner. Already clarified with BPN.",
  },
  {
    id: "c4", reporter: "Joko Widodo", property: "Rumah Jogja Selatan",
    category: "Spam", date: "2026-07-06", status: "open",
    message: "Duplicate listing for the same property posted by different accounts.",
  },
];
      ...
      <SafeAreaView style={styles.container} edges={["top"]}>
        ...
        <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={{ padding: 20, paddingBottom: 40 }}>
          ...
          <View style={styles.reporterCard}>
            ...
            <View>
              <Text style={styles.reporterName}>{c.reporter}</Text>
              ...
              >
                ...
                <View style={styles.complaintCardBody}>
                  ...
                  <Text style={styles.complaintReporter}>
                    <Text style={{ fontWeight: "700", color: TEXT_DARK }}>{c.reporter}</Text>
                    {" "}reported
                  </Text>
                  <Text style={styles.complaintProperty}>Property: {c.property}</Text>
